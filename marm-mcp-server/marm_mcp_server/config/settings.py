...
HYBRID_SEARCH_TEXT_WEIGHT = float(os.environ.get("HYBRID_SEARCH_TEXT_WEIGHT", "0.35"))
TEMPORAL_WEIGHT = float(os.environ.get("TEMPORAL_WEIGHT", "0.1"))
TEMPORAL_HALF_LIFE_DAYS = float(os.environ.get("TEMPORAL_HALF_LIFE_DAYS", "30"))
