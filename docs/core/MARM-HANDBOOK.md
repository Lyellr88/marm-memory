# MARM Handbook v2.2.7 (mainly for copy & paste users)
...
### v2.2.7 (Current) - Universal MCP Server
...
| Feature | Built-in AI Memory | MARM |
|---------|-------------------|------|
| **Control** | Limited, opaque | Full user control over what gets remembered |
| **Portability** | Platform-locked | Works across Claude, Gemini, Qwen, any MCP client |
| **Search** | Recency-based | Semantic similarity — finds by meaning not keywords |
| **Sharing** | Can't export or transfer | One memory database shared across all AI agents |
| **Validation** | No accuracy guarantees | Built-in transparency with `/show reasoning` |

**Q: Who is MARM for?**

Best fit: developers on long coding projects, researchers needing context continuity, power users working across multiple AI agents.

Not ideal for: quick one-off questions or users wanting fully automated hands-off memory.

**Q: Does MARM work without the MCP server?**

Yes — the original protocol (this handbook) works via copy/paste on any AI platform including ChatGPT, Claude, Gemini, and local models. No installation required.
